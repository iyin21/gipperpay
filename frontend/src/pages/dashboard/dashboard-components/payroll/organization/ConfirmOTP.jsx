...
const ConfirmOTP = ({showOTPModal, setShowOTPModal}) => {
  ...
  return (
    ...
    <div className="flex fixed top-0 right-0 w-full h-full justify-center backdrop-blur z-50 ">
      ...
      >
       ...
       <p className="font-medium text-m leading-8 text-secondary-main">Confirm O.T.P</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className="text-center mb-8 font-medium text-s leading-5 text-secondary-main">
            Didn't receive code?{" "}
            <span className="font-big text-primary-main">Resend OTP</span><br/>
