      ...
      <form action="">
        <div className="mt-11">
          ...
          <input
            ...
            onChange={(e) =>setTransactionDetails({...transactionDetails, reciversUserName: e.target.value})}
            placeholder="@"
          />
        </div>
        </div>
        ...
        <div className="w-[100%] h-[3.12rem] text-secondary-main flex items-center text-sm leading-7 font-medium bg-[white] border border-[#858095] rounded-md">
          ...
          <input
            ...
            onChange={(e) =>setTransactionDetails({...transactionDetails, gustAmount: e.target.value})}
