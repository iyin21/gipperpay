  ...
  return (
    <div className="w-[36rem] h-[45rem]  rounded-[10px] ml-[162px] mr-[432px] mt-[20px] pt-[40px] pb-[71px] border-white-20 border-[1px] pl-[128px] pr-[128]">
      ...
      <div className="w-[300px] h-[441px] mt-[39px] ml-[10px] mr-[10px] flex flex-col items-start ">
        ...
        <div className="w-[300px] h-[3rem] border mt-[5px] p-2 border-primary-90 rounded-[5px] flex flex-row items-center justify-between pr-[14px]">
          <div className="w-[83px] h-[33px] gap-2 bg-white-10 rounded-[5px] pt-[5px] pb-[5px] px-3 flex flex-row items-center ">
        ...
        <h1 className="mt-[5px] w-[96px] h-[27px] font-Jost not-italic font-medium text-sm leading-[27px] text-white-30 ">
          GU$T {(parseInt(amountToBuy / 725).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
        </h1>
        ...
        <div className=" w-[300px] h-[19px] mt-[10px] flex flex-row items-center justify-between ">
          ...
          <h1 className=" w-[66px] h-[19px] font-Jost not-italic  font-regular text-xs leading-[19px] text-white-30 ">
            {(parseInt(amountToBuy / 725).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} GU$T
          </h1>
        </div>
      </div>
